...
```
{
    "name": "Aikido Pre-Release Bug Bounty",
    "description": "Help test Aikido's new bounty creation wizard, launching on https://bounty.new in a few weeks. Submit a claim with as many bugs as you can find, winner take all. More info in the Discord. ",
