...
* In your [space settings](https://www.round.space/dashboard/settings) page, where you can enter an optional **Safe Wallet address**. Please note that you have to have an active Safe on the same chain you're setting up your space with. e.g. If you are using (polygon.round.space)[https://polygon.round.space], your linked Safe needs to be on Polygon as well.
...
Please ensure that the Safe being used has the active Round signed-in wallet as a signatory. For example, bounties created using a Safe on the space round.space/space/vitalik.eth should have vitalik.eth as an approver.  
