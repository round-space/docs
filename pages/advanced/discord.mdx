...
Aikido uses the [Widgetbot](www.widgetbot.io) embed to make this work. To install:
...
3. Add a link to that channel when you create a new bounty (you can add it as one of the 3 links you are allowed to embed on a bounty). To test, save a Bounty as a Draft before issuing on chain.
